...
#pragma region GLFW
  ...
  // NULL); glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_NORMAL); //
  // disable cursor
  if (!window) {
    glfwTerminate();
    return -1;
