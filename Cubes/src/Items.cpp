...
ItemInfo itemInfoTable[(int)ItemType::COUNT] = {
    ...
    {"Iron ore block", ItemType::IronOreBlock, BlockType::btIronOre,
     uiIronOreBlock, 1},
    {"Wood block", ItemType::WoodBlock, BlockType::btWood, uiWoodBlock, 1},
    {"Leaves block", ItemType::LeavesBlock, BlockType::btLeaves, uiLeavesBlock,
     1},
    ...
    {"Pickaxe",
     ...
     5,
     true,
     {ItemType::WoodBlock, ItemType::WoodBlock, ItemType::WoodBlock}},
    {"Sword",
     ItemType::Sword,
     BlockType::btAir,
     uiSword,
