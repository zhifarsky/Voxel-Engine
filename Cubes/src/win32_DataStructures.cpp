...
//// NOTE: возможно придется применить CRITICAL_SECTION в функциях для
///потокобезопасности
// struct WorkQueue {
...
//		res.taskIndex = InterlockedIncrement((LONG
//volatile*)&queue->nextTask) - 1; 		res.valid = true; 		_ReadBarrier();
//	}
//
//	return res;
// }
...
//	WorkingThread* thread = (WorkingThread*)calloc(1,
//sizeof(WorkingThread)); 	thread->id = id; 	thread->handle = CreateThread(0, 0,
//(LPTHREAD_START_ROUTINE)routine, argument, 0, 0); 	return thread;
// }
//
